    ...
    def _gen_grid(self, width, height):
        ...
        for idx, room in enumerate(roomList):
            ...
            if idx > 0:
                ...
                # self.grid.set(*room.entryDoorPos, Box(doorColor))
        ...
        # print('height:',self.grid.height)
        # print('Grid:',self.grid.grid)
        path = '/home/alain/Documents/GitHub/gym-minigrid/testgrid.pickle'
        ...
        #         print('grid imported!')
        #         self.grid, roomList = pickle.load(f)
        """
            SAVE/WRITE
        """
        with open(path,'wb+') as f:
            pickle.dump((self.grid,roomList),f)
            print('Entorno Guardado!')
...
class MultiRoomEnvN7(MultiRoomEnv):
    def __init__(self):
        super().__init__(
            minNumRooms=7,
            maxNumRooms=7,
