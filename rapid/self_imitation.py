...
from rapid.baselines_utils.segment_tree import SumSegmentTree, MinSegmentTree
from rapid.baselines_utils.misc_utils import discount_with_dones
...
class SelfImitation(object):
    ...
    def __init__(self, model_ob, model_vf, model_entropy,
            ...
            n_env=1, batch_size=512, n_update=1,
    ...
    def update_buffer(self, trajectory):
        ...
        # For this work, we store all the episodes as the large majority of them do not have ext reward
        positive_reward = True
        if positive_reward:
